/**
 * @file <argos3/plugins/robots/kilobot/control_interface/ci_kilobot_differential_steering_actuator.cpp>
 *
 * @author Carlo Pinciroli <ilpincy@gmail.com>
 */

#include "ci_kilobot_differential_steering_actuator.h"
...
namespace argos {
   ...
   int LuaSetDiffSteeringLinearVelocity(lua_State* pt_lua_state) {
      ...
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_KilobotDifferentialSteeringActuator>(pt_lua_state, "wheels")->
...
#ifdef ARGOS_WITH_LUA
   void CCI_KilobotDifferentialSteeringActuator::CreateLuaState(lua_State* pt_lua_state) {
