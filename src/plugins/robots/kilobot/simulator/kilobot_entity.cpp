...
namespace argos {
   ...
   CKilobotEntity::CKilobotEntity(const std::string& str_id,
      ...
      try {
         ...
         m_pcWheeledEntity->SetWheel(0, CVector3(0.0f,  HALF_INTERPIN_DISTANCE, 0.0f), PIN_WHEEL_RADIUS);
         m_pcWheeledEntity->SetWheel(1, CVector3(0.0f, -HALF_INTERPIN_DISTANCE, 0.0f), PIN_WHEEL_RADIUS);
         /* LED equipped entity */
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   REGISTER_ENTITY(CKilobotEntity,
                   ...
                   "1.0",
                   "The kilobot robot, developed at Harvard University by the Self-organizing\n"
